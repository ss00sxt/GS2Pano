...
tile_ug, tile_vg, tile_pr, tile_D, tile_ids = _build_tile_inputs(ug, vg, pr, D, WIDTH)
...
rad[0,:,0]=torch.from_numpy(tile_pr).cuda(); rad[0,:,1]=torch.from_numpy(tile_pr).cuda()
